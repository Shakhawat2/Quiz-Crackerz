...
const Footer = () => {
    return (
        <footer data-aos="zoom-in-up" className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                        <img src="https://d2q79iu7y748jz.cloudfront.net/s/_squarelogo/48482230db0c4d1ac6e61fc06543ba59" className='' alt="No Image" />
                        </div>
                        <span className="self-center text-2xl font-semibold">JCH QUIZ CONTEST</span>
                    </a>
                </div>
